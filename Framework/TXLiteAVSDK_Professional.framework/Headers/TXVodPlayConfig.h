 ...
 */
extern NSInteger const INDEX_AUTO;

/**
 * 音量均衡预设参数：音量均衡，关
 */
extern float const AUDIO_NORMALIZATION_OFF;

/**
 * 音量均衡预设参数：音量均衡，标准响度
 */
extern float const AUDIO_NORMALIZATION_STANDARD;

/**
 * 音量均衡预设参数：音量均衡，低响度
 */
extern float const AUDIO_NORMALIZATION_LOW;

/**
 * 音量均衡预设参数：音量均衡，高响度
 */
extern float const AUDIO_NORMALIZATION_HIGH;
...
///显示处理标志位
///设置Render 显示后处理标志位，包含超分等功能，使用这些功能需要设置此标志位，默认为YES
